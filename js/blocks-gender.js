$(document).ready(function() {
    ...
    // console.log(person);
    var table_html = [
        '<table class="table" id="table_gender"><tr><th></th><th>Present</th><th>Not Present</th></tr><tr><th>Male</th><td class="type_gender2 white">' + prescription[2][1] + '%</td><td class="type_gender0 black">' + prescription[1][1] + '%</td></tr><tr><th>Female</th><td class="type_gender3">' + prescription[3][1] + '%</td><td class="type_gender5">' + prescription[4][1] + '%</td></tr></table>',
